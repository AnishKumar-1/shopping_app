...
public class GlobalErrorHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentError(MethodArgumentNotValidException arg, HttpServletRequest request){
        List<String> argError=arg.getBindingResult().getFieldErrors()
